...
class SpecialProgramExceptionController extends Controller
{
    public function index(): Response
    {
        return Inertia::render('admin/special-programs/exceptions/index');
    }
    ...
    public function updateEvent(Request $request, Event $event): RedirectResponse
    {
        ...
        EventAuditLog::create([
            ...
            'action' => 'special_program_exception_updated',
    ...
    public function refund(Request $request, EventBooking $booking): RedirectResponse
    {
        ...
        EventAuditLog::create([
            'admin_id' => $request->user()->id,
            'action' => 'special_program_refund_created',
