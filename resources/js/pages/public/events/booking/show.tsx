                ...
                <div className="grid gap-6 lg:grid-cols-[1.25fr_0.9fr]">
                    <div className="space-y-6">
                        <div className="rounded-2xl bg-white p-6 shadow-sm">
                            <h1 className="text-2xl font-semibold text-slate-900">Detail Booking Event</h1>
                            <p className="mt-2 text-sm text-slate-500">Ringkasan pesanan event kamu.</p>
                            <div className="mt-6 grid gap-4 text-sm text-slate-600">
                                ...
                                <div className="flex items-center justify-between">
                                    <span>Lokasi</span>
                                    <span className="font-semibold text-slate-900">{booking.event.location ?? '-'}</span>
                                </div>
                                <div className="flex items-center justify-between">
                                    <span>Tiket</span>
                    ...
                    <aside className="space-y-6">
                        <div className="rounded-2xl bg-white p-6 shadow-sm">
                            ...
                            {booking.status === 'pending_payment' && (
                                <Link
                                    href={`/events/booking/${booking.encrypted_id}/payment`}
                            ...
                            {(booking.status === 'paid' || booking.status === 'completed') && (
                                <button
                                    ...
                                    onClick={() => {
                                        ...
                                        window.open(`/events/booking/${booking.encrypted_id}/ticket`, '_blank');
