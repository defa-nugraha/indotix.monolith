...
import { CalendarCheck, MapPinned, ShoppingBag, Star, Ticket, Wifi, ParkingSquare, Waves, Dumbbell, Utensils, Coffee, Users, ShieldCheck } from 'lucide-react';
                        ...
                        <div key={room.id} className="rounded-2xl bg-white p-6 shadow-sm">
                            ...
                            <div className="mt-4">
                                <button
                                    ...
                                    onClick={() => {
                                        form.setData('room_type_id', room.id);
                                        form.post('/booking/prepare');
                                    }}
                                >
                                    Pilih Kamar
                                </button>
