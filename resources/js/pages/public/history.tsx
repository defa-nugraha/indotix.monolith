...
export default function History({ bookings = [] }: { bookings: Booking[] }) {
    ...
    const filteredBookings = useMemo(() => {
        return bookings.filter((booking) => {
            ...
            const haystack = `${booking.hotel_name ?? ''} ${booking.city_name ?? ''} ${booking.address ?? ''}`.toLowerCase();
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <div className="flex flex-wrap items-center gap-2">
                                                <h3 className="text-lg font-semibold text-slate-900">{booking.hotel_name ?? 'Hotel'}</h3>
                                    ...
                                    <div className="flex flex-col items-start gap-3 lg:items-end">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {booking.status === 'pending_payment' && (
                                                <Link
                                                    href={`/booking/${booking.encrypted_id}/payment`}
                                            ...
                                            <Link
                                                href={`/booking/${booking.encrypted_id}`}
