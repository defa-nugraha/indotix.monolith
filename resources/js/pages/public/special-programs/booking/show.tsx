...
type Booking = {
    ...
    qr_url?: string | null;
    qr_data?: string | null;
    program: { id: number; name: string; category?: string | null };
    variant?: { id?: number | null; name?: string | null } | null;
    guest: { name: string; email: string; phone: string };
    review?: { can_review?: boolean; url?: string | null } | null;
};

export default function SpecialProgramBookingShow({
    booking,
}: {
    booking: Booking;
}) {
                    ...
                    <div className="space-y-6">
                        <div className="rounded-2xl bg-white p-6 shadow-sm">
                            <h1 className="text-2xl font-semibold text-slate-900">
                                Detail Booking Special Program
                            </h1>
                            <p className="mt-2 text-sm text-slate-500">
                                Ringkasan pesanan special program kamu.
                            </p>
                    ...
                    <aside className="space-y-6">
                            ...
                            {isPaid && (
                                <button
                                    ...
                                    onClick={() => {
                                        ...
                                        window.open(
                                            `/special-programs/booking/${booking.encrypted_id}/ticket`,
                                            '_blank',
                                        );
                                        window.setTimeout(
                        ...
                        {isPaid && booking.qr_url && (
                            <div className="rounded-2xl border border-slate-200 bg-white p-4 text-center shadow-sm">
                                ...
                                <div className="mt-2 text-xs text-slate-500">
                                    Tunjukkan QR ini saat validasi di lokasi.
                                </div>
                            </div>
                        )}
                    </aside>
