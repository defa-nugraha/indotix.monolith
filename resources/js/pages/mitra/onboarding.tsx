...
export default function MitraOnboarding({
    ...
    const isVerificationVerified = onboarding.verification_status === 'verified';
            ...
            <div className="relative flex flex-1 flex-col gap-6 overflow-x-hidden bg-[#f6fbff] px-6 py-8 font-['Plus_Jakarta_Sans'] text-slate-900">
                ...
                <section className="rounded-3xl border border-sky-100/80 bg-white/90 p-6 shadow-sm">
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            ...
                            <h1 className="mt-2 text-2xl font-semibold text-slate-900 font-['Space_Grotesk']">
                                Halo, {auth?.user?.name}
                            </h1>
                            <p className="text-sm text-slate-600">
                                Lengkapi tahapan agar hotel dapat tampil dan menerima booking.
                            </p>
                        </div>
                ...
                {status === 'onboarding-saved' && (
                    ...
                    {status === 'verification-submitted' && (
                        <div className="mt-4 rounded-2xl border border-amber-100 bg-amber-50 px-4 py-3 text-sm text-amber-700">
                            Dokumen verifikasi sudah dikirim. Menunggu review admin.
                        </div>
                    )}
                ...
                {onboarding.verification_status === 'rejected' && onboarding.verification_reason && (
                    <div className="mt-4 rounded-2xl border border-red-100 bg-red-50 px-4 py-3 text-sm text-red-700">
                        Verifikasi ditolak: {onboarding.verification_reason}
                    </div>
                )}
                    ...
                    <section className="rounded-3xl border border-sky-100/80 bg-white/90 p-6 shadow-sm">
                        ...
                        <div className="mt-6 grid gap-4 md:grid-cols-2">
                            <div className="grid gap-2">
                                <Label htmlFor="hotel_name">Nama hotel/properti</Label>
                                <Input
                                    id="hotel_name"
                                    value={step1Form.data.hotel_name}
                                    onChange={(event) =>
                                        step1Form.setData('hotel_name', event.target.value)
                                    }
                                    placeholder="Contoh: Hotel Indotix"
                                />
                                <InputError message={step1Form.errors.hotel_name} />
                            </div>
                            <div className="grid gap-2">
                                <Label>Jenis properti</Label>
                                <Select
                                    value={step1Form.data.property_type}
                                    onValueChange={(value) => step1Form.setData('property_type', value)}
                                >
                                    <SelectTrigger>
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value="kost_harian">Kost Harian</SelectItem>
                                    </SelectContent>
                                </Select>
                                <InputError message={step1Form.errors.property_type} />
                            </div>
                            <div className="grid gap-2">
                                <Label>Kota</Label>
                                <Select
                                    value={step1Form.data.city_code}
                                    onValueChange={(value) => step1Form.setData('city_code', value)}
                                >
                                    <SelectTrigger>
                                ...
                                <InputError message={step1Form.errors.city_code} />
                            </div>
                            <div className="grid gap-2">
                                <Label htmlFor="address_short">Alamat singkat</Label>
                                <Input
                                    id="address_short"
                                    value={step1Form.data.address_short}
                                    onChange={(event) =>
                                        step1Form.setData('address_short', event.target.value)
                                    }
                                    placeholder="Contoh: Jl. Merdeka No. 10"
                                />
                                <InputError message={step1Form.errors.address_short} />
                            </div>
                            <div className="grid gap-2">
                                <Label htmlFor="estimated_room_count">Jumlah kamar (perkiraan)</Label>
                                <Input
                                    ...
                                    onChange={(event) =>
                                        step1Form.setData('estimated_room_count', event.target.value)
                                    }
                                    placeholder="Contoh: 24"
                                />
                                <InputError message={step1Form.errors.estimated_room_count} />
                            </div>
                        </div>
                            ...
                            <Button
                                ...
                                onClick={() =>
                                    step1Form.patch('/mitra/onboarding/step-1', {
                                        ...
                                        onSuccess: () => {
                                            setActiveStep(2);
                                            showSuccess('Berhasil', 'Data tahap 1 tersimpan.');
                                        },
                                        onError: (errors) => {
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(event) =>
                                            step2Form.setData('responsible_name', event.target.value)
                                        }
                                    />
                                    <InputError message={step2Form.errors.responsible_name} />
                                </div>
                                <div className="grid gap-2">
                                    <Label>NIK</Label>
                                    <Input
                                        ...
                                        onChange={(event) =>
                                            step2Form.setData('responsible_nik', event.target.value)
                                        }
                                    />
                                    <InputError message={step2Form.errors.responsible_nik} />
                                </div>
                                <div className="grid gap-2">
                                    <Label>Jabatan</Label>
                                    <Select
                                        value={step2Form.data.responsible_role}
                                        onValueChange={(value) => step2Form.setData('responsible_role', value)}
                                    >
                                        <SelectTrigger>
                                    ...
                                    <InputError message={step2Form.errors.responsible_role} />
                                </div>
                            <div className="grid gap-2">
                                ...
                                <FilePicker
                                    ...
                                    onChange={(file) =>
                                        handleFileChange('ktp', file, 'ktp_file')
                                    }
                                />
                                <InputError message={step2Form.errors.ktp_file} />
                            </div>
                            <div className="grid gap-2">
                                ...
                                <FilePicker
                                    ...
                                    accept="image/*"
                                    fileName={step2Form.data.selfie_ktp_file?.name}
                                    previewUrl={filePreviews.selfie ?? getPublicUrl(onboarding.selfie_ktp_path)}
                                    onChange={(file) =>
                                        handleFileChange('selfie', file, 'selfie_ktp_file')
                                    }
                                />
                                <InputError message={step2Form.errors.selfie_ktp_file} />
                            </div>
                            </div>
                                ...
                                <div className="mt-4 grid gap-4 md:grid-cols-2">
                                    <div className="grid gap-2">
                                        ...
                                        <Select
                                            ...
                                            onValueChange={(value) =>
                                                step2Form.setData('legal_doc_type', value)
                                            }
                                        >
                                            <SelectTrigger>
                                            ...
                                            <SelectContent>
                                                ...
                                                <SelectItem value="surat_izin_daerah">Surat izin daerah</SelectItem>
                                                <SelectItem value="surat_rt_rw">Surat RT/RW</SelectItem>
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <Input
                                            ...
                                            onChange={(event) =>
                                                step2Form.setData('legal_doc_number', event.target.value)
                                            }
                                        />
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <FilePicker
                                            ...
                                            onChange={(file) =>
                                                handleFileChange('legal', file, 'legal_doc_file')
                                            }
                                        />
                                ...
                                <div className="mt-4 grid gap-4 md:grid-cols-3">
                                    <div className="grid gap-2">
                                        ...
                                        <FilePicker
                                            ...
                                            helper="Files Supported: JPG, PNG"
                                            accept="image/*"
                                            fileName={step2Form.data.photo_front_file?.name}
                                            previewUrl={filePreviews.front ?? getPublicUrl(onboarding.photo_front_path)}
                                            onChange={(file) =>
                                                handleFileChange('front', file, 'photo_front_file')
                                            }
                                        />
                                        <InputError message={step2Form.errors.photo_front_file} />
                                    </div>
                                    <div className="grid gap-2">
                                        ...
                                        <FilePicker
                                            ...
                                            helper="Files Supported: JPG, PNG"
                                            accept="image/*"
                                            fileName={step2Form.data.photo_lobby_file?.name}
                                            previewUrl={filePreviews.lobby ?? getPublicUrl(onboarding.photo_lobby_path)}
                                            onChange={(file) =>
                                                handleFileChange('lobby', file, 'photo_lobby_file')
                                            }
                                        />
                                        <InputError message={step2Form.errors.photo_lobby_file} />
                                    </div>
                                    <div className="grid gap-2">
                                        ...
                                        <FilePicker
                                            ...
                                            helper="Files Supported: JPG, PNG"
                                            accept="image/*"
                                            fileName={step2Form.data.photo_room_file?.name}
                                            previewUrl={filePreviews.room ?? getPublicUrl(onboarding.photo_room_path)}
                                            onChange={(file) =>
                                                handleFileChange('room', file, 'photo_room_file')
                                            }
                                        />
                                        <InputError message={step2Form.errors.photo_room_file} />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                <div className="grid gap-2 md:col-span-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(event) =>
                                            step2Form.setData('address_full', event.target.value)
                                        }
                                ...
                                <div className="grid gap-2 md:col-span-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(event) =>
                                            step2Form.setData('maps_pin_url', event.target.value)
                                        }
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(event) =>
                                            step2Form.setData('reception_phone', event.target.value)
                                        }
                                    />
                                    <InputError message={step2Form.errors.reception_phone} />
                                </div>
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(event) =>
                                            step2Form.setData('operational_hours', event.target.value)
                                        }
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(event) =>
                                            step2Form.setData('reservation_pic', event.target.value)
                                        }
                                    />
                                    <InputError message={step2Form.errors.reservation_pic} />
                                </div>
                            </div>
                                ...
                                <Button
                                    ...
                                    onClick={() =>
                                        step2Form.post('/mitra/onboarding/step-2', {
                                            ...
                                            onSuccess: () => {
                                                setActiveStep(3);
                                                showSuccess('Berhasil', 'Dokumen berhasil disimpan.');
                                            },
                                            onError: (errors) => {
                                                showError('Gagal menyimpan', getFirstError(errors));
                                            },
                        ...
                        <div className="mt-6 grid gap-4 md:grid-cols-2">
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    onChange={(event) =>
                                        step3Form.setData('bank_name', event.target.value)
                                    }
                                />
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    onChange={(event) =>
                                        step3Form.setData('bank_account_number', event.target.value)
                                    }
                                />
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    onChange={(event) =>
                                        step3Form.setData('bank_account_name', event.target.value)
                                    }
                                />
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    onChange={(event) =>
                                        step3Form.setData('tax_npwp', event.target.value)
                                    }
                                />
                                <InputError message={step3Form.errors.tax_npwp} />
                            </div>
                            <div className="grid gap-2">
                                <Label>Tipe pajak (opsional)</Label>
                                <Select
                                    value={step3Form.data.tax_type}
                                    onValueChange={(value) => step3Form.setData('tax_type', value)}
                                >
                                    <SelectTrigger>
                                ...
                                <InputError message={step3Form.errors.tax_type} />
                            </div>
                        </div>
                            ...
                            <Button
                                ...
                                onClick={() =>
                                    step3Form.patch('/mitra/onboarding/step-3', {
                                        ...
                                        onSuccess: () => {
                                            setActiveStep(3);
                                            showSuccess('Berhasil', 'Data rekening tersimpan.');
                                        },
                                        onError: (errors) => {
                                            showError('Gagal menyimpan', getFirstError(errors));
                                        },
