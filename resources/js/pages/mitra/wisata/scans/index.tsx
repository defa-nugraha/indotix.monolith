            ...
            <div className="flex flex-1 flex-col gap-6 bg-[#f6fbff] px-6 py-8">
                ...
                {activeTab === 'qr' && (
                    <section className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
                        ...
                        >
                            <div className="printable-entry-qr relative mx-auto aspect-[1086/1536] w-[min(390px,calc(100vw-2rem))] max-w-[390px] min-w-0 overflow-hidden rounded-[26px] border-[6px] border-[#116fd4] bg-white shadow-[0_28px_70px_-42px_rgba(15,23,42,0.5)]">
                                ...
                                <div className="absolute inset-x-0 bottom-[1.5%] text-center text-[12px] font-semibold text-white">
                                    {qrTemplate.customer_service ||
                                        'Customer Service: 089...'}
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex flex-wrap items-start justify-between gap-4">
                                <div>
                                    ...
                                    <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
                                        Mitra tidak perlu scan tiket user. Cetak
                                        QR ini, letakkan di area masuk, lalu
                                        user akan scan QR dan memilih tiket yang
                                        akan digunakan.
                                    </p>
                                </div>
                                <div
