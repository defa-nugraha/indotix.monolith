...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Exception & Refund', href: '/admin/events/exceptions' },
];

export default function EventExceptionsIndex() {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Exception Handling Event" />
            <div className="flex flex-1 flex-col gap-6 bg-[#f6fbff] px-6 py-8">
                <section className="rounded-3xl border border-sky-100/80 bg-white/90 p-6 shadow-sm">
                    <h1 className="text-2xl font-semibold text-slate-900">Postpone / Cancel Event</h1>
                    <p className="text-sm text-slate-500">Set status event dan alasan krisis.</p>
                    <form
                        ...
                        onSubmit={(event) => {
                            ...
                            router.post(`/admin/events/${eventId}/exception`, Object.fromEntries(data.entries()), { preserveScroll: true });
                        }}
                    >
                        <input name="event_id" placeholder="ID Event" className="rounded-lg border border-slate-200 px-3 py-2 text-sm" />
                ...
                <section className="rounded-3xl border border-sky-100/80 bg-white/90 p-6 shadow-sm">
                    ...
                    <form
                        ...
                        onSubmit={(event) => {
                            ...
                            router.post(`/admin/events/bookings/${bookingId}/refund`, Object.fromEntries(data.entries()), { preserveScroll: true });
                        }}
                    >
