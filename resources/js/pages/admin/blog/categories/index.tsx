...
export default function BlogCategoriesIndex({ categories = [] }: { categories: Category[] }) {
    ...
    const submit = () => {
        form.post('/admin/blog/categories', {
            ...
            onSuccess: () => {
                form.reset();
                Swal.fire({ icon: 'success', title: 'Berhasil', text: 'Kategori ditambahkan.' });
            },
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-1 flex-col gap-6 bg-[#f6fbff] px-6 py-8">
                <section className="rounded-3xl border border-sky-100/80 bg-white/90 p-6 shadow-sm">
                    <h1 className="text-2xl font-semibold text-slate-900">Kategori Jelajah Indotix</h1>
                    <p className="text-sm text-slate-500">Kelola kategori artikel untuk memudahkan pengelompokan konten.</p>
