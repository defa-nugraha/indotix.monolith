...
type DestinationOption = { id: number; destination_name: string };
...
export default function WisataAffiliateCommissions({
    commissions,
    destinations,
    campaigns,
}: Props) {
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm text-slate-500">
                                Buat komisi global atau per wisata/campaign.
                            </p>
                        </div>
