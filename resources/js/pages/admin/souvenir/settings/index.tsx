...
export default function SouvenirSettingsIndex({ settings }: { settings: Settings }) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Konfigurasi Souvenir', href: '/admin/souvenir/settings' },
    ];
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Konfigurasi Souvenir" />
            <div className="flex flex-1 flex-col gap-6 bg-[#f6fbff] px-6 py-8">
                <section className="rounded-3xl border border-sky-100/80 bg-white/90 p-6 shadow-sm">
                    <h1 className="text-2xl font-semibold text-slate-900">Konfigurasi Souvenir</h1>
