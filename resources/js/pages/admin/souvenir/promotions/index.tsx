...
export default function SouvenirPromotionsIndex({
    promotions,
    programs,
}: {
        ...
        form.post('/admin/retail-shop/promotions', {
            ...
            onError: () =>
                Swal.fire({
                    icon: 'error',
                    title: 'Gagal',
                    text: 'Tidak dapat menyimpan promo.',
                }),
        });
    };
        ...
        router.put(`/admin/retail-shop/promotions/${promotionId}`, payload, {
            ...
            onSuccess: () =>
                Swal.fire({
                    icon: 'success',
                    title: 'Berhasil',
                    text: 'Promo diperbarui.',
                }),
            onError: () =>
                Swal.fire({
                    icon: 'error',
                    title: 'Gagal',
                    text: 'Tidak dapat memperbarui promo.',
                }),
        });
    };
        ...
        router.delete(`/admin/retail-shop/promotions/${promotionId}`, {
            ...
            onError: () =>
                Swal.fire({
                    icon: 'error',
                    title: 'Gagal',
                    text: 'Tidak dapat menghapus promo.',
                }),
        });
    };
