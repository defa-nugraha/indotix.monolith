...
export default function SouvenirProductsIndex({
    products,
    categories,
    filters,
}: Props) {
    ...
    const canAddEditImages =
        maxImages - (existingImages.length + editPreviews.length);
    ...
    useEffect(() => {
        ...
        const urls = editData.images.map((file: File) =>
    ...
    const submitEdit = (productId: number) => {
        router.post(
            `/admin/retail-shop/products/${productId}`,
        ...
        router.delete(`/admin/retail-shop/products/${productId}`, {
            ...
            onSuccess: () =>
                Swal.fire({
                    icon: 'success',
                    title: 'Berhasil',
                    text: 'Produk dinonaktifkan.',
                }),
            onError: () =>
                Swal.fire({
                    icon: 'error',
                    title: 'Gagal',
                    text: 'Tidak dapat menonaktifkan produk.',
                }),
        });
    };
    ...
    const duplicate = (productId: number) => {
        router.post(
            `/admin/retail-shop/products/${productId}/duplicate`,
            {},
            {
                preserveScroll: true,
                onSuccess: () =>
                    Swal.fire({
                        icon: 'success',
                        title: 'Berhasil',
                        text: 'Produk diduplikasi.',
                    }),
                onError: () =>
                    Swal.fire({
                        icon: 'error',
                        title: 'Gagal',
                        text: 'Tidak dapat duplikasi produk.',
                    }),
            },
        );
    };
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3">
                        <div>
                            <h1 className="text-2xl font-semibold text-slate-900">
                                Master Produk Retail Shop
                            </h1>
                            <p className="text-sm text-slate-500">
                                Tambah dan kelola katalog produk souvenir.
                            </p>
                        </div>
                        <Button
                ...
                <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
                    <DialogContent className="max-h-[90vh] max-w-3xl overflow-y-auto">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Lengkapi data produk sebelum disimpan.
                            </DialogDescription>
                        </DialogHeader>
                    ...
                    <DialogContent className="max-h-[90vh] max-w-3xl overflow-y-auto">
                            ...
                            <div className="space-y-1">
                                ...
                                <input
                                    ...
                                    onChange={(event) =>
                                        setEditData({
                                            ...editData,
                                            cost_price: parseCurrencyToInteger(
                                                event.target.value,
                                            ),
                                        })
                                    }
                                    ...
                                    <div className="mt-3 grid grid-cols-5 gap-2">
                                        {existingImages.map((image) => (
                                            ...
                                            >
                                                ...
                                                <button
                                                    type="button"
                                                    className="absolute top-1 right-1 rounded-full bg-white/90 px-2 text-xs text-rose-600 shadow"
                                                    onClick={(event) => {
                                                        event.preventDefault();
                        ...
                        <DialogFooter className="gap-2">
                            ...
                            <Button
                                ...
                                type="button"
                                onClick={() =>
                                    editingId && submitEdit(editingId)
                                }
                            >
                                Simpan Perubahan
                            </Button>
