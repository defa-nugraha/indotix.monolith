...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .route-col { display: flex; gap: 12px; }
        .route-line { width: 10px; position: relative; }
        .dot { width: 8px; height: 8px; border-radius: 50%; background: #0ea5e9; margin-top: 4px; }
        .line { position: absolute; top: 12px; left: 3px; width: 2px; height: 46px; background: #cbd5f5; }
        .route-title { font-size: 12px; color: #64748b; }
    ...
    <div class="ticket">
        ...
        <div class="topbar">
            <div>
                ...
                <div class="subtitle">Pemesanan Tiket Wisata</div>
            </div>
        </div>
        ...
        <div class="meta">
            <div class="meta-left">
                ...
                <div class="date">{{ $booking->visit_date?->format('l, d F Y') }}</div>
            </div>
            <div>
        ...
        <div class="route">
            <div>
                <div class="section-title" style="margin-top:0;">Informasi Destinasi</div>
        ...
        <div class="section-title">Detail Pengunjung</div>
        <table>
            <thead>
                <tr>
                    <th>No</th>
