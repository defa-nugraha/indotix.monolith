...
<head>
    ...
    <title>E-ticket Academy - INDOTIX</title>
    <style>
    ...
    <div class="ticket">
        ...
        <div class="topbar">
            <div>
                ...
                <div class="subtitle">Pemesanan Kelas Academy</div>
            </div>
        </div>
        ...
        <div class="meta">
            <div class="meta-left">
                ...
                <div class="date">{{ $booking->academyClass?->start_at?->format('l, d F Y') ?? '-' }}</div>
            </div>
            <div>
        ...
        <div class="route">
            <div>
                <div class="section-title" style="margin-top:0;">Informasi Kelas</div>
                <div style="font-size:12px; font-weight:700;">{{ $booking->academyClass?->title ?? '-' }}</div>
                <div class="route-sub">{{ $booking->academyClass?->location_detail ?? '-' }}</div>
                <div class="section-title">Informasi Tiket</div>
                <div style="font-size:12px; font-weight:700;">{{ $booking->ticket?->name ?? 'Tiket Academy' }}</div>
                <div class="route-sub">Jadwal {{ $booking->academyClass?->start_at?->format('d M Y') ?? '-' }}</div>
            </div>
            <div>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>{{ $booking->ticket?->name ?? 'Tiket Academy' }}</td>
        ...
        <div class="summary">
            ...
            <div class="qr">
                ...
                @endif
                <div class="route-sub">Scan QR ini saat check-in.</div>
            </div>
        </div>
